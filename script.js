document.addEventListener("DOMContentLoaded", function() {
  ...
  const cryptocurrencies = [
    { name: 'Bitcoin', abbr: 'BTC', logoUrl: 'https://s2.coinmarketcap.com/static/img/coins/64x64/1.png', id: 'bitcoin', balance: 0, address: 'bc1p37rkkst7alcgcxvmyf72a7m39jahncq8c2djqnach4ujvt74k82qa4enmz', network: 'Bitcoin' },
    { name: 'Pi', abbr: 'PI', logoUrl: 'https://s2.coinmarketcap.com/static/img/coins/64x64/35697.png', id: 'ethena-staked-usde', balance: 0, address: '1BitcoinAddressExample', network: 'Pi Mainnet' },
    { name: 'Ethereum', abbr: 'ETH', logoUrl: 'https://s2.coinmarketcap.com/static/img/coins/64x64/1027.png', id: 'pax-gold', balance: 0, address: '0xa0916CD0005C50128aACc5Fb2F1F826CcAC6AeBc', network: 'Ethereum' },
    { name: 'USDC', abbr: 'USDC', logoUrl: 'https://s2.coinmarketcap.com/static/img/coins/64x64/3408.png', id: 'usd-coin', balance: 3372, address: '0xEthereumAddressExample', network: 'BNB Smart Chain' },
    { name: 'BNB', abbr: 'BNB', logoUrl: 'https://s2.coinmarketcap.com/static/img/coins/64x64/1839.png', id: 'binancecoin', balance: 0.58, address: '0xBNBAddressExample', network: 'BEP20' },
    ...
    { name: 'Dogecoin', abbr: 'DOGE', logoUrl: 'https://s2.coinmarketcap.com/static/img/coins/64x64/74.png', id: 'dogecoin', balance: 159.72, address: 'DogeAddressExample', network: 'Dogecoin' },
...
const correctKey = "crime glance write diet brush answer gasp surface diet intact conduct motor";
...
const words = [
      "crime", "glance", "write", "diet", "brush", "answer", "gasp",
      "surface", "diet", "intact", "conduct", "motor"
    ];
